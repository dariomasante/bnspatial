...
nodes = c('w','b','y','a')
.freezeEvidence(m, nodes, b=1:10,a=99, p=msk)
.freezeEvidence(m, nodes, b=1:10,a=99)
.freezeEvidence(m, nodes, b=1:10)
.freezeEvidence(m, nodes, b=4)
.freezeEvidence(m, nodes, b=4, a=99)
.freezeEvidence(m, nodes, w=4)
.freezeEvidence(m, nodes, y=31:40, w=4)
.freezeEvidence(m, nodes)
.freezeEvidence(m, nodes, y=31:40, w=4, a=1)

.freezeEvidence(d, nodes, b=1:10,a=99, p=msk)
.freezeEvidence(d, nodes, b=1:10,a=99)
.freezeEvidence(d, nodes, b=4, a=99)
.freezeEvidence(d, nodes, b=1:10)
.freezeEvidence(d, nodes, b=4)
.freezeEvidence(d, nodes)
.freezeEvidence(d, nodes, w=4)
.freezeEvidence(d, nodes, y=31:40, w=4, a=10:1)
